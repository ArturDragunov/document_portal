...
class FastAPIFileAdapter: # reformats file into a suitable format
...
def read_pdf_via_handler(handler, path: str) -> str:
    """Helper function to read PDF using handler.
    It tries calling either read_pdf() or read_() methods on the provided handler object,
    falling back with an error if neither exists."""
